...
Other variables need to be converted to factors
...
Fixing `status` and factor variables are the only fix we need to make. In the real
...
The results indicate 1.0 mg of estrogen cause a `r 1 - exp(-0.3705)`
reduction in hazard while other doses of estrogen actually increased
the risk of death in the study population. It's important to consider
...
either way and more data is needed. Although I'm no doctor, some hypothesize
